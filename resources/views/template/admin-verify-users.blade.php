                                ...
                                <tbody>
                                    @foreach ($users as $user)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($user->is_verified)
                                                    <span class="badge badge-success">Not Verified</span></td>
                                                @else
                                                    <span class="badge badge-danger">Not Verified</span></td>
                                                @endif
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item" href="{{route('admin.verify.user.detail', ['id' => $user->id])}}">Verify</a>
